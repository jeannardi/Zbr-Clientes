...
Class DataGridViewPrinter
        ...
        If PageNumber = 0 Then
            ...
            For i As Integer = 0 To TheDataGridView.Columns.Count - 1
                ...
                For j As Integer = 0 To TheDataGridView.Rows.Count - 1
                    ...
                    tmpSize = g.MeasureString("Qualquer uma", tmpFont)
    ...
    Public Function DrawDataGridView(g As Graphics) As Boolean
        ...
        Catch ex As Exception
            MessageBox.Show("Operação falhou: " + ex.Message.ToString(), Application.ProductName + " - Error", MessageBoxButtons.OK, MessageBoxIcon.[Error])
            Return False
        End Try
    End Function
End Class
